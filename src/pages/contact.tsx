      ...
      <main>
        ...
        <div className="w-full min-h-screen z-10 bg-black bg-opacity-10">
          <Hero
            ...
            subtitle="Nous sommes disponibles pour répondre à toutes vos questions et vous accompagner dans vos projets."
            bgVideo="/bg.mp4"
            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                >
                  ...
                  <option className="text-black" value="information">Demande d'information</option>
                  <option className="text-black" value="reclamation">Réclamation</option>
                  <option className="text-black" value="recruitment">Recrutement/Stage</option>
                  <option className="text-black" value="other">Autres</option>
                </select>
                <textarea
                  name="message"
                  rows={6}
                ...
                <button
                  type="submit"
                  className="pointer-events-auto px-8 py-4 before:bg-[#1066af] hover:text-white hover:border-[#1066af] mt-6 md:mt-8 bg-[#2591c2] text-zinc-100 border-[#2591c2] font-bold rounded-lg transition-all duration-300"
                >
                  Envoyer
                </button>
              </form>

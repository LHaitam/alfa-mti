      ...
      {LINKS.map((link) => (
        <NavLink
          ...
          active={
            ...
            (link.href === "/sectors" &&
              ["/sectors/medical", "/sectors/railway"].includes(router.pathname))
          }
      ...
      <Link href={href} className="relative">
        <span
          className={`relative font-semibold transition-all ${
            active
              ? "text-[#2591c2] border-b-2 border-[#2591c2]"
              : "text-white hover:text-[#2591c2]"
          }`}
        >
          {children}
        </span>
...
const MobileMenuLink = ({
  ...
  <div className="text-neutral-950 border-b border-neutral-300 py-6">
    <Link
      href={href}
      onClick={() => setMenuOpen(false)}
      className="text-2xl font-semibold hover:text-[#2591c2]"
    >
      {children}
    </Link>
  </div>
  ...
  },
  {
    ...
    component: () => (
      <div className="grid gap-4">
        <Link href="/sectors/medical" className="hover:text-[#2591c2]">
          Médical
        </Link>
        <Link href="/sectors/railway" className="hover:text-[#2591c2]">
          Ferroviaire
        </Link>
      </div>
    ),

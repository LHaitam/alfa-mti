    ...
    <section id="key-figures" className="section-wrapper text-black">
      ...
      <Reveal>
        <p className="leading-relaxed text-black">
          <span className="font-bold text-[#2591c2]">AMTI</span>, depuis sa fondation, a affirmé son rôle de pilier de l&apos;industrie marocaine. Forte de son expertise et de son engagement envers l&apos;innovation, la qualité et la souveraineté industrielle, <span className="font-bold text-[#2591c2]">AMTI</span> a su établir des standards d&apos;excellence. Nos performances exceptionnelles, illustrées par nos chiffres clés, témoignent de notre capacité à répondre aux exigences des professionnels de la santé, tout en élargissant notre impact à d&apos;autres secteurs industriels stratégiques.
        </p>
      </Reveal>
      <Reveal>
